...
namespace ScreenCapture {
    public static class ScreenCapture {
        ...
        public static Bitmap CaptureWindow(IntPtr ihandle, int display = 0) {
            try {
                ...
                captureGraphics.CopyFromScreen(rc.Left, rc.Top, 0, 0, new Size(rc.Right - rc.Left, rc.Bottom - rc.Top), CopyPixelOperation.SourcePaint);
